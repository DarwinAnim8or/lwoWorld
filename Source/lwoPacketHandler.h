...
namespace lwoPacketHandler {
	void determinePacketHeader(RakPeerInterface* rakServer, Packet* packet, lwoUserPool* userPool, ReplicaManager* replicaManager);
	...
	void handleWorldConnPackets(RakPeerInterface* rakServer, Packet* packet, lwoUserPool* userPool, ReplicaManager* replicaManager);
};